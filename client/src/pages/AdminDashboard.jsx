          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            >
              ...
              <div className="text-emerald-800/80">
                View profiles, limits, histories, and remove members.
              </div>
            </button>
            <button
            ...
            >
              ...
              <div className="text-purple-800/80">
                Create/cancel/fulfill/expire reservations and issue/return
                loans.
              </div>
            </button>
            <button
            ...
            >
              ...
              <div className="text-sky-800/80">
                Book popularity, member activity, and fines summary.
              </div>
            </button>
          </div>
        </section>
