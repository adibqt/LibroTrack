...
export default function AdminMemberManager() {
  ...
  const filtered = useMemo(() => {
    ...
    return members.filter((m) =>
      [m.username, m.email, m.first_name, m.last_name].some((x) =>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => onField("user_type", e.target.value)}
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      min="0"
                      value={profile.max_books_allowed ?? 0}
                      onChange={(e) =>
                        onField("max_books_allowed", e.target.value)
                      }
                      className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      disabled
                      value={profile.current_books_borrowed ?? 0}
                  ...
                  <div>
                    ...
                    <div className="max-h-48 overflow-auto rounded border border-slate-200">
                      <table className="min-w-full divide-y divide-slate-200 text-sm">
                        <thead className="bg-slate-50">
                          <tr>
                            <th className="px-3 py-1.5 text-left font-medium text-slate-700">
                              Loan ID
                            </th>
                            <th className="px-3 py-1.5 text-left font-medium text-slate-700">
                              Title
